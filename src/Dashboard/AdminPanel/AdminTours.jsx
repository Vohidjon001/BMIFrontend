      ...
      <div className="flex flex-col gap-5 overflow-x-scroll">
        <table className="table-auto gap-4 border-collapse border w-[120%] md:w-full">
          <thead className="w-full py-2">
            <tr>
              <th></th>
              <th className="tableData text-start">Sarlavha</th>
              <th className="tableData">Shahar</th>
              <th className="tableData">Tanlangan</th>
              <th className="tableData">Maksimal odamlar</th>
              <th className="tableData">Sharhlar</th>
            </tr>
          </thead>
          {tours?.map((tour) => (
